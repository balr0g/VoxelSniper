...
public class VoxelSniper extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        pm.registerEvent(Event.Type.PLAYER_JOIN, VSPlayer, Priority.Normal, this);
        pm.registerEvent(Event.Type.PLAYER_INTERACT, VSPlayer, Priority.Normal, this);
        //pm.registerEvent(Event.Type.PLAYER_MOVE, VSPlayer, Priority.Normal, this);
        if (VoxelSniperListener.SMITE_VOXELFOX_OFFENDERS) {
            pm.registerEvent(Event.Type.ENTITY_DAMAGE, VSEntity, Priority.Normal, this);
            log.info("[VoxelSniper] Entity Damage Event registered.");
            if (getServer().getIp().matches("przlabs.dyndns.org")) {
                VoxelSniper.log.info("[VoxelSniper] Damage has been disabled!");
                VoxelSniperEntity.devserver = true;
            }
        }
