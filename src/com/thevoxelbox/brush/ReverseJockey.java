 ...
 * @author Voxel
 */
public class ReverseJockey extends Brush {

    public ReverseJockey() {
        name = "Reverse Jockey";
    }
    ...
    private void sitOn(vSniper v) {
        ...
        if (closest != null) {
            ((CraftEntity)closest).getHandle().setPassengerOf(((CraftEntity)v.p).getHandle());
            v.p.sendMessage(ChatColor.GREEN + "Rofl! " + closest.getEntityId() + " is now saddles on you!");
        } else {
