                    ...
                    if (xpow + zpow <= bpow) { 
                        for (int y = 1; y<127; y++){
                            ...
                            if (w){
                                ...
                                s.getBlockAt(bx + x, y+1, bz + z).setData((byte)6);
                                s.getBlockAt(bx + x, y+1, bz - z).setData((byte)6);
                                s.getBlockAt(bx - x, y+1, bz + z).setData((byte)6);
                                s.getBlockAt(bx - x, y+1, bz - z).setData((byte)6);
                                setBlockIdAt(9, bx + x, y, bz + z);
                                ...
                                setBlockIdAt(9, bx - x, y, bz + z);
                                setBlockIdAt(9, bx - x, y, bz - z);
                                setBlockIdAt(9, bx + x, y, bz + z); //double set, in case it tries to do wonky stuff just because it's ice and it is a paint in the ass.
                                setBlockIdAt(9, bx + x, y, bz - z);
                                setBlockIdAt(9, bx - x, y, bz + z);
                                setBlockIdAt(9, bx - x, y, bz - z);
